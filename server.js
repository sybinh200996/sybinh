...
app.post("/api/teacher-ai", async (req, res) => {
  try {
    ...
    const parts = [{ text: `
Bạn là "Đặng Năm AI" trong app SyNam Mystic Professional. Hãy trả lời bằng tiếng Việt, giọng ấm áp, gần gũi, có màu sắc huyền học nhưng không mê tín cực đoan.
...
app.post("/api/love-ai", async (req, res) => {
  try {
    ...
    const parts = [{ text: `
Bạn là chuyên gia luận TÌNH DUYÊN/HỢP TUỔI bằng tiếng Việt trong app SyNam Mystic Professional. Hãy viết chi tiết, rõ ràng, có cấu trúc đẹp.
